    ...
    <div class="panel-body">
      {!! Form::model($candidate, [
        ...
        <div class="form-group">
          ...
          {!! Form::textarea('hero', null, ['class' => 'form-control', 'placeholder' => __('projection.hero_placeholder')]) !!}
        </div>

        <div class="form-group">
          {!! Form::label('dev_qualities', __('projection.dev_qualities'), ['class' => 'control-label']) !!}
          {!! Form::textarea('dev_qualities', null, ['class' => 'form-control', 'placeholder' => __('projection.dev_qualities_placeholder')]) !!}
        </div>

        <div class="form-group">
          {!! Form::label('personal_goal', __('projection.personal_goal'), ['class' => 'control-label']) !!}
          {!! Form::textarea('personal_goal', null, ['class' => 'form-control', 'placeholder' => __('projection.personal_goal_placeholder')]) !!}
        </div>
        ...
        <div class="form-group">
          ...
          {!! Form::textarea('superpower', null, ['class' => 'form-control', 'placeholder' => __('projection.superpower_placeholder')]) !!}
        </div>
