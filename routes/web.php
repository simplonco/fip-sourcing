...
Route::group(['middleware' => 'recruiter'], function () {
  ...
  Route::get('/recruiter/formations/edit/{id}', 'Recruiter\FormationController@recruiterFormationEdit')->name('trainer.courses.edit');
  Route::post('/recruiter/formations/update/{id}', 'Recruiter\FormationController@recruiterFormationUpdate')->name('trainer.courses.update');
  Route::get('/recruiter/formations/candidats/recherche', 'Recruiter\CandidateController@recruiterCandidateSearch')->name('trainer.courses.applicants.search'); // !!! \\
  Route::get('/recruiter/formations/mail', 'Recruiter\FormationController@sendMail')->name('trainer.mailing');
